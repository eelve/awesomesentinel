...
public class GlobalExceptionHandler {
    ...
    public JsonResult<Void> handleException(UndeclaredThrowableException e) {
        JsonResult<Void> r = new JsonResult<Void>();
        log.info("error 我被熔断了 UndeclaredThrowableException");
        r.setCode(500);
        r.setMsg("我被熔断了 UndeclaredThrowableException");
        return r;
    }
    ...
    public JsonResult<Void> handleException(BlockException e) {
        JsonResult<Void> r = new JsonResult<Void>();
        log.info("error 我被熔断了 BlockException");
        r.setCode(500);
        r.setMsg("我被熔断了 BlockException");
        return r;
    }
